...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'ncprac.csv', 'path': 'resources/ncprac.csv'},
    {'name': 'nc2test.csv', 'path': 'resources/nc2test.csv'},
  ]
});
...
function preloopLoopBegin(preloopLoopScheduler, snapshot) {
  return async function() {
    ...
    preloop = new TrialHandler({
      ...
      trialList: '/Users/klaytonchan/Desktop/nc1/resources/ncprac.csv',
...
function testloopLoopBegin(testloopLoopScheduler, snapshot) {
  return async function() {
    ...
    testloop = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: '/Users/klaytonchan/Desktop/nc1/resources/nc2test.csv',
